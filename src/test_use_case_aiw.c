...
subscriber_channel_t MIC_DATA_CHANNEL;

void INIT_Test_Use_Case_AIW() 
{
    message_store_test_case_aiw = MPAI_MessageStore_Creator(AIW_TEMP_LIMIT_DETECTION, "AIF_USE_CASE", sizeof(mpai_parser_t));
    ...
    MIC_DATA_CHANNEL = MPAI_MessageStore_new_channel();
}
